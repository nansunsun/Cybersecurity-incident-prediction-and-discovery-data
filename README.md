...
- [6] Discover the correlation between mismanaged networks and maliciousness of the networks: [On the Mismanagement and Maliciousness of
Networks (NDSS, 2014)](http://web.eecs.umich.edu/~mingyan/pub/NDSS2014.pdf)
...
- [8] Predict whether a currently benign website has high risk of becoming malicious in the future: [Automatically detecting vulnerable websites
before they turn malicious (Usenix, 2014)](https://www.usenix.org/node/184496)
...
|[16]|[LibTIFF, FFmpeg, Pidgin, VLC, MediaPlayer, Asterisk open source project codes(https://github.com/DanielLin1986/TransferRepresentationLearning/tree/master/Data/VulnerabilityData)|Open-source project codes|
